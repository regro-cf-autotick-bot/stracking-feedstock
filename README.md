...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/stracking-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15414&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/stracking-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `stracking` can be installed with:

```
conda install stracking
```

It is possible to list all of the versions of `stracking` available on your platform with:
